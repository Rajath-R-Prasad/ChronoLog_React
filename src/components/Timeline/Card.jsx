...
function Card({id,date,message,deleteCard}) {
  ...
  return (
    <>
      <div 
      className='w-[80vw]  md:w-[17vw] h-[25vh] md:h-[30vh] overflow-hidden text-white text-xl md:text-2xl m-4 rounded-t-3xl shadow-lg shadow-neutral-700  border-[#ddbf80] border'>
